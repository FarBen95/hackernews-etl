...
resource "aws_subnet" "private_subnet_b" {
  vpc_id            = aws_vpc.vpc.id
  cidr_block        = var.private_subnet_b["cidr_block"]
  availability_zone = var.private_subnet_b["az"]
  tags = {
    Name = "${var.project}-subnet-b-private"
  }
}

resource "aws_subnet" "private_subnet_c" {
  vpc_id            = aws_vpc.vpc.id
  cidr_block        = var.private_subnet_c["cidr_block"]
  availability_zone = var.private_subnet_c["az"]
  tags = {
    Name = "${var.project}-subnet-c-private"
  }
}
